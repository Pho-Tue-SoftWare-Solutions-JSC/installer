...
TXT_PANEL_ALREADY_INSTALLED="Панель управления HiTechCloud уже установлена, повторная установка невозможна"
TXT_SET_INSTALL_DIR="Укажите директорию для установки HiTechCloud (по умолчанию /opt): "
...
TXT_DOCKER_INSTALL_FAIL="Установка Docker не удалась\nВы можете попробовать установить Docker, используя оффлайн-пакет, обратитесь к следующей ссылке для подробных инструкций: https://docs.hitechcloud.vn/installation/"
...
TXT_SET_PANEL_PORT="Укажите порт HiTechCloud (по умолчанию"
...
TXT_SET_PANEL_ENTRANCE="Установите безопасный вход HiTechCloud (по умолчанию"
...
TXT_SET_PANEL_USER="Установите пользователя панели HiTechCloud (по умолчанию"
...
TXT_SET_PANEL_PASSWORD="Установите пароль панели HiTechCloud, нажмите Enter после установки (по умолчанию"
TXT_INPUT_PASSWORD_RULE="Ошибка: Пароль панели поддерживает только буквы, цифры, специальные символы (!@#$%*_,.?), длина 8-30 символов"
TXT_CONFIGURE_PANEL_SERVICE="Настройка службы HiTechCloud"
TXT_START_PANEL_SERVICE="Запуск службы HiTechCloud"
TXT_SERVICE_RETRY_MSG="Ошибка запуска службы, повторная попытка..."
TXT_PANEL_SERVICE_START_SUCCESS="Служба HiTechCloud успешно запущена. Продолжается выполнение последующих настроек, пожалуйста, подождите..."
TXT_PANEL_SERVICE_START_ERROR="Ошибка запуска службы HiTechCloud!"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Официальный сайт: https://hitechcloud.vn"
TXT_PROJECT_DOCUMENTATION="Документация проекта: https://docs.hitechcloud.vn"
TXT_PROJECT_REPOSITORY="Репозиторий кода: https://github.com/HiTechCloud-dev/HiTechCloud"
TXT_COMMUNITY="Присоединяйтесь к сообществу HiTechCloud в Discord для поддержки и обсуждений: https://discord.gg/hitechcloud"
...
TXT_PANEL_SERVICE_STATUS="Проверить статус службы HiTechCloud"
TXT_PANEL_SERVICE_RESTART="Перезапустить службу HiTechCloud"
TXT_PANEL_SERVICE_STOP="Остановить службу HiTechCloud"
TXT_PANEL_SERVICE_START="Запустить службу HiTechCloud"
TXT_PANEL_SERVICE_UNINSTALL="Удалить службу HiTechCloud"
TXT_PANEL_SERVICE_USER_INFO="Получить информацию о пользователе HiTechCloud"
TXT_PANEL_SERVICE_LISTEN_IP="Переключить IP прослушивания HiTechCloud"
TXT_PANEL_SERVICE_VERSION="Получить информацию о версии HiTechCloud"
TXT_PANEL_SERVICE_UPDATE="Обновить системную информацию HiTechCloud"
TXT_PANEL_SERVICE_RESET="Сбросить системную информацию HiTechCloud"
TXT_PANEL_SERVICE_RESTORE="Восстановить службу и данные HiTechCloud"
TXT_PANEL_SERVICE_UNINSTALL_NOTICE="Удаление остановит и удалит службу HiTechCloud. Продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNINSTALL_START="Начало удаления панели управления сервером HiTechCloud для Linux"
TXT_PANEL_SERVICE_UNINSTALL_STOP="Остановка процессов службы HiTechCloud"
TXT_PANEL_SERVICE_UNINSTALL_REMOVE="Удаление исполняемых файлов HiTechCloud и связанных конфигураций службы"
...
TXT_PANEL_DATA_KEEP_PROMPT="Удалить каталог данных HiTechCloud? [y/n]: "
TXT_PANEL_DATA_KEEP="Сохранить каталог данных HiTechCloud"
TXT_PANEL_DATA_DELETE="Удалить каталог данных HiTechCloud"
TXT_PANEL_SERVICE_RESTORE_NOTICE="HiTechCloud будет восстановлен до последней стабильной версии. Хотите продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNSUPPORTED_PARAMETER="Неподдерживаемые параметры, используйте help или --help для получения справки"
TXT_PANEL_CONTROL_SCRIPT="Скрипт управления HiTechCloud"
